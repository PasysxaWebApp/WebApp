...
namespace Pasys.Web.Identity.Models
{
    public class AppIdentityDbInitializer : DropCreateDatabaseIfModelChanges<AppIdentityDbContext>
    {
        ...
        public static void InitializeIdentityForEF(AppIdentityDbContext db)
        {
            ...
            var m = new ApplicationFunction { FunctionId = 1, ParentFunctionId = 1, MenuName = "ホーム", ActionName = "Index", ControllerName = "Home", CssClass = "icons_24_home", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 2, ParentFunctionId = 2, MenuName = "記録", ActionName = "", ControllerName = "", CssClass = "icons_24_record", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 3, ParentFunctionId = 2, MenuName = "飼育記録", ActionName = "FarmRecodeList", ControllerName = "FarmRecode", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 4, ParentFunctionId = 2, MenuName = "単価変更", ActionName = "Index", ControllerName = "PriceAdjust", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 15, ParentFunctionId = 2, MenuName = "単価変更", ActionName = "Edit", ControllerName = "PriceAdjust", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 5, ParentFunctionId = 5, MenuName = "集計", ActionName = "", ControllerName = "", CssClass = "icons_24_sum", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 6, ParentFunctionId = 5, MenuName = "生簀一覧（日次）", ActionName = "FishSpeciesList", ControllerName = "FishSpeciesList", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 7, ParentFunctionId = 5, MenuName = "生簀一覧（月次）", ActionName = "FishSpeciesListMonth", ControllerName = "FishSpeciesListMonth", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 8, ParentFunctionId = 8, MenuName = "特殊", ActionName = "", ControllerName = "", CssClass = "icons_24_spe", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 9, ParentFunctionId = 8, MenuName = "分割一覧", ActionName = "Index", ControllerName = "Division", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 10, ParentFunctionId = 8, MenuName = "災害一覧", ActionName = "Index", ControllerName = "Disaster", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 11, ParentFunctionId = 11, MenuName = "設定", ActionName = "", ControllerName = "", CssClass = "icons_24_setting", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 12, ParentFunctionId = 11, MenuName = "漁場設定", ActionName = "FishingGroundList", ControllerName = "FishingGround", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 13, ParentFunctionId = 11, MenuName = "生簀分類設定", ActionName = "FishSpeciesGroupList", ControllerName = "FishSpeciesGroup", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 14, ParentFunctionId = 11, MenuName = "生簀設定", ActionName = "FishSpeciesList", ControllerName = "FishSpecies", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 15, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 16, ParentFunctionId = 11, MenuName = "環境情報設定", ActionName = "EnvironmentList", ControllerName = "Environment", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 17, ParentFunctionId = 11, MenuName = "チェック項目設定", ActionName = "CheckItemList", ControllerName = "CheckItem", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 18, ParentFunctionId = 11, MenuName = "作業項目設定", ActionName = "WorkItemList", ControllerName = "WorkItem", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 19, ParentFunctionId = 11, MenuName = "給餌状況設定", ActionName = "BaitStatusList", ControllerName = "BaitStatus", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 20, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 21, ParentFunctionId = 11, MenuName = "魚種設定", ActionName = "FishKindList", ControllerName = "FishKind", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 22, ParentFunctionId = 11, MenuName = "斃死理由設定", ActionName = "DeadReasonList", ControllerName = "DeadReason", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 23, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 24, ParentFunctionId = 11, MenuName = "種苗導入記録", ActionName = "SeedIntroRecodeList", ControllerName = "SeedIntroRecode", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 25, ParentFunctionId = 11, MenuName = "仕入先設定", ActionName = "StockToList", ControllerName = "StockTo", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 26, ParentFunctionId = 11, MenuName = "出荷先設定", ActionName = "ShipmentToList", ControllerName = "ShipmentTo", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 27, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 28, ParentFunctionId = 11, MenuName = "飼料設定", ActionName = "FeedList", ControllerName = "Feed", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 29, ParentFunctionId = 11, MenuName = "栄養剤設定", ActionName = "NutrientList", ControllerName = "Nutrient", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 30, ParentFunctionId = 11, MenuName = "薬設定", ActionName = "MedicineList", ControllerName = "Medicine", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 31, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 32, ParentFunctionId = 11, MenuName = "ユーザー招待管理", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 33, ParentFunctionId = 33, MenuName = "PASYS設定", ActionName = "", ControllerName = "", CssClass = "icons_24_setting", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 34, ParentFunctionId = 33, MenuName = "事業所設定", ActionName = "Index", ControllerName = "Organization", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 35, ParentFunctionId = 33, MenuName = "ユーザー管理", ActionName = "UserList", ControllerName = "User", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 36, ParentFunctionId = 33, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 37, ParentFunctionId = 11, MenuName = "飼料区分設定", ActionName = "FeedDivList", ControllerName = "FeedDiv", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 38, ParentFunctionId = 33, MenuName = "投与物計上設定", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 39, ParentFunctionId = 33, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 40, ParentFunctionId = 33, MenuName = "種苗種類設定", ActionName = "SeedKindList", ControllerName = "SeedKind", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 41, ParentFunctionId = 33, MenuName = "生簀計上設定", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 42, ParentFunctionId = 33, MenuName = "網種類設定", ActionName = "NetList", ControllerName = "Net", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 43, ParentFunctionId = 33, MenuName = "共通魚種設定", ActionName = "PublicFishKindList", ControllerName = "PublicFishKind", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 44, ParentFunctionId = 33, MenuName = "輸送方法設定", ActionName = "TransportList", ControllerName = "Transport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 45, ParentFunctionId = 33, MenuName = "種苗由来設定", ActionName = "SeedOriginList", ControllerName = "SeedOrigin", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 46, ParentFunctionId = 46, MenuName = "レポート", ActionName = "", ControllerName = "", CssClass = "icons_24_report", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 47, ParentFunctionId = 46, MenuName = "斃死レポート", ActionName = "DeadReportList", ControllerName = "DeadReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 48, ParentFunctionId = 46, MenuName = "チェックレポート", ActionName = "CheckReportList", ControllerName = "CheckReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 49, ParentFunctionId = 46, MenuName = "作業レポート", ActionName = "WorkReportList", ControllerName = "WorkReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 50, ParentFunctionId = 46, MenuName = "出荷レポート", ActionName = "ShipmentReportList", ControllerName = "ShipmentReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 51, ParentFunctionId = 46, MenuName = "生簀情報CSVレポート", ActionName = "FishSpeciesReportList", ControllerName = "FishSpeciesReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 52, ParentFunctionId = 46, MenuName = "月次レポート", ActionName = "MonthReportList", ControllerName = "MonthReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 53, ParentFunctionId = 46, MenuName = "投与物レポート", ActionName = "MortalityReportsList", ControllerName = "MortalityReports", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 54, ParentFunctionId = 46, MenuName = "日々レポート", ActionName = "DayReportList", ControllerName = "DayReport", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 55, ParentFunctionId = 33, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 56, ParentFunctionId = 33, MenuName = "エラーログ", ActionName = "ErrorLogList", ControllerName = "ErrorLog", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 57, ParentFunctionId = 33, MenuName = "アクセスログ", ActionName = "AccessLogList", ControllerName = "AccessLog", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 58, ParentFunctionId = 33, MenuName = "システム利用状況", ActionName = "UseSituationList", ControllerName = "UseSituation", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 59, ParentFunctionId = 33, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 60, ParentFunctionId = 33, MenuName = "システム管理項目マスタ", ActionName = "Index", ControllerName = "SystemSetting", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 61, ParentFunctionId = 2, MenuName = "飼育記録", ActionName = "BatchSave", ControllerName = "FishSpecieStatus", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 62, ParentFunctionId = 11, MenuName = "間接経費科目一覧", ActionName = "Index", ControllerName = "AccountsTitle", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 63, ParentFunctionId = 2, MenuName = "間接経費一覧", ActionName = "Index", ControllerName = "IndirectCost", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 64, ParentFunctionId = 11, MenuName = "事業所設定", ActionName = "Index", ControllerName = "Organization", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 65, ParentFunctionId = 11, MenuName = "ユーザー管理", ActionName = "Index", ControllerName = "UserManage", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            //m = new ApplicationMenu { FunctionId = 66, ParentFunctionId = 11, MenuName = "--", ActionName = "", ControllerName = "", CssClass = "", ActionParam = "" };
            //roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 67, ParentFunctionId = 11, MenuName = "間接経費科目設定", ActionName = "Index", ControllerName = "AccountsTitle", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 68, ParentFunctionId = 11, MenuName = "調整理由", ActionName = "AdjustReasonList", ControllerName = "AdjustReason", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
            m = new ApplicationFunction { FunctionId = 69, ParentFunctionId = 33, MenuName = "お知らせ", ActionName = "Index", ControllerName = "Notice", CssClass = "", ActionParam = "" };
            roleManager.CreateMenu(m);
