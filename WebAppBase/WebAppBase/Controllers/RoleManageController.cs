...
namespace WebAppBase.Controllers
{
    public class RoleManageController : Controller
    {
        ...
        public RoleManageController(ApplicationUserManager userManager,
        ...
        public async Task<ActionResult> Create(RoleViewModel roleViewModel)
        {
            ...
            {
                var role = new ApplicationRole("DebugOrganizationID", roleViewModel.Name, roleViewModel.Description);
