...
namespace Pasys.Web.Core
{
    ...
    public class GlobalConfigInfo : IConfigInfo
    {
        ...
        #region CarWash
        private int _carWashMallAdminGroupID;
        private int _carWashProductTypeID;
        private int _carWashShipCoId;
        private string _carWashServicePhone;
        private int _carWashLucyHomeStoreID;
        private decimal _carWashFirstOrderAmount;
        private int _carwashautoassignorder;
      
        public int CarWashMallAdminGroupID
        {
            get { return _carWashMallAdminGroupID; }
            set { _carWashMallAdminGroupID = value; }
        }
        
        public int CarWashProductTypeID
        {
            get { return _carWashProductTypeID; }
            set { _carWashProductTypeID = value; }
        }
        public int CarWashShipCoId
        {
            get { return _carWashShipCoId; }
            set { _carWashShipCoId = value; }
        }
        public string CarWashServicePhone
        {
            get { return _carWashServicePhone; }
            set { _carWashServicePhone = value; }
        }
        public int CarWashLucyHomeStoreID
        {
            get { return _carWashLucyHomeStoreID; }
            set { _carWashLucyHomeStoreID = value; }
        }
        public decimal CarWashFirstOrderAmount
        {
            get { return _carWashFirstOrderAmount; }
            set { _carWashFirstOrderAmount = value; }
        }

        public int CarWashAutoAssignOrder
        {
            get { return _carwashautoassignorder; }
            set { _carwashautoassignorder = value; }
        }
        #endregion
    }
}
